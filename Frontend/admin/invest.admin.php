...
?>
    <div class="page-header">
        ...
        <small>Accueil / investisseurs</small>
    </div><br><br>
    ...
    <div id="form-template" class="hidden">
        <form action="../../Backend/signup.exp.back.php" method="post" enctype="multipart/form-data"
            id="requestResources">
            <h3 class="modalTitle">Ajout d'investisseur</h3>
            <fieldset><br>
                <p class="inputTitle">Nom de famille investisseur</p>
                <input type="text" placeholder="Nom de famille" class="inputText" id="f_name" name="f_name" required>
            </fieldset>
            <fieldset>
                <p class="inputTitle">Prenoms investisseur</p>
                <input type="text" placeholder="Prenoms" class="inputText" id="l_name" name="l_name" required>
            </fieldset>
            <fieldset>
                <p class="inputTitle">nom d'utilisateur investisseur</p>
                <input type="text" placeholder="Nom utilisateur" class="inputText" name="uid" id="uid" required>
            </fieldset>
            <fieldset>
                <p class="inputTitle">Email investisseur</p>
                <input type="email" placeholder="Email" class="inputText" name="email" id="email" required>
            </fieldset>
            <fieldset>
                <p class="inputTitle">Mot de passe investisseur</p>
            ...
            <fieldset>
                <p class="inputTitle">Genre investisseur</p>
    ...
    <div class="records table-responsive">
        <div>
            <table width="100%">
                ...
                <tbody>
                    <?php
                    $query = 'SELECT * FROM users WHERE userLevel = 2 ';
                    ...
                    <tr>
                        ...
                        <?php
                        $sql =
                            'SELECT COUNT(*) as nb_proj FROM projet where projet_ass= ' .
                            $row['idUsers'] .
                            ' ;';
                        ...
                        <td>
                            <div class="actions">
                                <a href="../../Backend/delete.users.back.php?id=<?php echo $row[
                                    'idUsers'
                                ]; ?>&page=invest" class="delBtn">suprimer</a> <br><br>
                            </div>
                        </td>
                    </tr>
                    <?php }
